...
/**
 * The Tests entity class represents the structure of a test in the system.
...
public class Tests {
	...
	public String toString() {
		return "Tests [test_id=" + test_id + ", test_name=" + test_name + ", home_sample=" + home_sample
	...
	/**
	 * Parameterized constructor for the Tests class.
	 *
	 ...
	 */
	public Tests(long test_id, String test_name, String home_sample, String test_description, int price,
